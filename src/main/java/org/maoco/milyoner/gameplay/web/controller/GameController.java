...
public class GameController {
    ...
    public ApiResponse<StartGameResponse> startGame(@RequestBody @Valid StartGameRequest request) {
        String token = gameService.startGame(request);
    ...
    public ApiResponse<GameQuestionQueryResponse> getQuestions() {
        Game game = gameService.getQuestions();
    ...
    @PostMapping("/result")
    public ApiResponse<UserScoreResponse> getGameResult() {
        UserScore userScore = gameService.getResult();
